...
All workloads used seeded Gaussian data, 20 original dimensions, two embedding
...
resources in `__init__`. Unless stated otherwise, one embedding was evaluated.
...
Eight repeated embeddings show essentially the same conclusion: v0.5.0 took
...
- Native batch width four made the eight-embedding Torch MPS suite 2.21x faster
...
6. Repeated embeddings share immutable original resources and can use bounded
