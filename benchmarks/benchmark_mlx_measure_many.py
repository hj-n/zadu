"""Benchmark sequential and native-batched MLX repeated-embedding execution."""
...
def main() -> None:
    ...
    payload = {
        ...
        "cold_maximum_score_delta": _maximum_score_delta(sequential_cold, batched_cold),
        "warm_maximum_score_delta": _maximum_score_delta(sequential_cold, batched_warm),
